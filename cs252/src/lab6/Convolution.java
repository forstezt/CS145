...
public class Convolution {
	...
	public static UWECImage convolve(UWECImage in, Mask m, UWECImage out, ImagePanel outPanel, int i, int numThreads) {

		int start = ((in.getWidth() / numThreads) * i);
		int width = start + ((in.getWidth() / numThreads));
